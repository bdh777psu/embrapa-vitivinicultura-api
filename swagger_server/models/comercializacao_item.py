...
class ComercializacaoItem(Model):
    ...
    def __init__(self, categoria: str=None, cultivar: str=None, ano: int=None, quantidade: str=None):  # noqa: E501
        ...
        :type categoria: str
        :param cultivar: The cultivar of this ComercializacaoItem.  # noqa: E501
        :type cultivar: str
    ...
    @classmethod
    def from_dict(cls, dikt) -> 'ComercializacaoItem':
        """Returns the dict as a model

        :param dikt: A dict.
        :type: dict
        :return: The ComercializacaoItem of this ComercializacaoItem.  # noqa: E501
        :rtype: ComercializacaoItem
        """
        return util.deserialize_model(dikt, cls)

    @property
    def categoria(self) -> str:
        """Gets the categoria of this ComercializacaoItem.


        :return: The categoria of this ComercializacaoItem.
        :rtype: str
        """
    ...
    def categoria(self, categoria: str):
        """Sets the categoria of this ComercializacaoItem.


        :param categoria: The categoria of this ComercializacaoItem.
        :type categoria: str
        """
    ...
    def cultivar(self) -> str:
        """Gets the cultivar of this ComercializacaoItem.


        :return: The cultivar of this ComercializacaoItem.
        :rtype: str
        """
    ...
    def cultivar(self, cultivar: str):
        """Sets the cultivar of this ComercializacaoItem.


        :param cultivar: The cultivar of this ComercializacaoItem.
        :type cultivar: str
        """
        if cultivar is None:
    ...
    @property
    def ano(self) -> int:
        """Gets the ano of this ComercializacaoItem.


        :return: The ano of this ComercializacaoItem.
        :rtype: int
        """
        return self._ano
    ...
    def ano(self, ano: int):
        """Sets the ano of this ComercializacaoItem.


        :param ano: The ano of this ComercializacaoItem.
        :type ano: int
        """
        if ano is None:
